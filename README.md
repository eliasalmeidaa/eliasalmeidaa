...
&nbsp;
![Profile Views](https://komarev.com/ghpvc/?username=eliasalmeidaa&color=00f7ff&style=flat-square&label=Visitantes)
...
class Elias:
    nome     = "Elias Almeida"
    usuario  = "@eliasalmeidaa"
    foco     = ["Desenvolvimento", "Algoritmos", "Projetos Open Source"]
    stacks   = ["Python", "C", "C++", "JavaScript", "HTML", "CSS"]
    hobbies  = ["Codar", "Aprender coisas novas", "Resolver problemas"]
    motto    = "Código limpo hoje = menos dor amanhã 💡"
```
...
<div align="center">
  <img height="180em" src="https://github-readme-stats.vercel.app/api?username=eliasalmeidaa&show_icons=true&theme=tokyonight&include_all_commits=true&count_private=true&border_radius=10"/>
